...
<template>
  <UButton variant="outline" :color="isOverDropZone ? 'primary' : 'neutral'"
    ...
    <div class="w-full flex items-center justify-center">
      <div v-if="!uploading" class="w-full">
        <div v-if="!isSmallScreen" class="w-full rounded-md flex items-center justify-center h-[430px]">
          ...
          <div
            class="relative opacity-0 group-hover:opacity-100 flex w-full h-full justify-center items-center transition-all duration-100">
